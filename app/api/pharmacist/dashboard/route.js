...
// GET - Fetch pharmacist dashboard data
export async function GET() {
  try {
    ...
    // Get pending prescriptions with details
    const { data: pendingPrescriptions } = await supabaseAdmin
      .from(TABLES.PRESCRIPTIONS)
      .select(
        `
        id,
    ...
    return NextResponse.json({
      stats: {
        ...
        totalDispensed: totalDispensedCount || 0,
      },
