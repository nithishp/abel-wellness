  ...
  const handleSubmit = async (status) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.push(`/pharmacist/inventory/purchase-orders/${data.order.id}`);
      } else {
                        ...
                        >
                          ...
                          <td className="p-3">
                            <input
                              ...
                              className="w-20 px-2 py-1 bg-slate-700 border border-slate-600 rounded text-white text-center focus:outline-none focus:border-purple-500"
                              min="1"
                            />
                          </td>
                          <td className="p-3">
                            <input
                              ...
                              className="w-24 px-2 py-1 bg-slate-700 border border-slate-600 rounded text-white text-right focus:outline-none focus:border-purple-500"
                              min="0"
                              step="0.01"
                            />
                          </td>
