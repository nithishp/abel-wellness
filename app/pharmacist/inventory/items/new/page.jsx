        ...
        <div className="mb-4 ml-12 lg:ml-0">
          <Breadcrumb
            items={[
              ...
              { label: "Items", href: "/pharmacist/inventory/items" },
              { label: "Add New Item" },
            ]}
            showBackButton={true}
            backHref="/pharmacist/inventory/items"
          />
        </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl">
          ...
          {formData.item_type === "medication" &&
            [
              ...
              <div className="bg-slate-800/50 rounded-xl border border-purple-700/50 p-6 mb-6">
                <h2 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div>
                ...
                <input
                  ...
                  min="0"
                  placeholder="0"
                  className="w-full px-3 py-2 bg-slate-700/50 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-purple-500 placeholder-slate-500"
                />
              </div>
              <div>
                <label className="block text-sm text-slate-400 mb-1">
