...
const PharmacistEditInventoryItemPage = ({ params }) => {
  const { id } = use(params);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.push(`/pharmacist/inventory/items/${id}`);
      } else {
      ...
      <main className="lg:ml-72 min-h-screen p-6 overflow-auto">
        ...
        <div className="flex items-center justify-between mb-6 ml-12 lg:ml-0">
          <div className="flex items-center gap-4">
            <Link
              href={`/pharmacist/inventory/items/${id}`}
...
export default PharmacistEditInventoryItemPage;
