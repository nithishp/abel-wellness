...
export const createBlog = async (data) => {
  try {
    ...
    const databaseId = DATABASE_ID || process.env.DATABASE_ID || process.env.NEXT_PUBLIC_DATABASE_ID;
    const blogsId = BLOGS_ID || process.env.BLOGS_ID || process.env.NEXT_PUBLIC_BLOGS_ID || "blogs";
    
    if (!databaseId) {
      throw new Error("Database ID is not configured. Please check your environment variables.");
    }
