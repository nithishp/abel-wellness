...
export const emailTemplates = {
  ...
  appointmentCancelled: (patientName, appointmentDetails, reason) => ({
    subject: "Appointment Cancelled - Abel Wellness",
    html: baseTemplate(`
      <h2>Hello ${patientName},</h2>
      ...
      <div class="warning-box">
        ...
        <p style="margin-top: 15px;"><strong>Reason for Cancellation:</strong></p>
        <p style="background: #fee2e2; padding: 10px; border-radius: 6px; color: #991b1b;">${reason}</p>
      </div>
